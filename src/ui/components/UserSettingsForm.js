      ...
      m("fieldset", [
        m(
          ...
          m("input.form-control", {
            oninput: m.withAttr("value", setInputValue.bind(null, "image")),
            value: state.formData.image,
            type: "text",
            autocomplete: "off",
            placeholder: "URL of profile picture",
            disabled: vnode.attrs.isUserSettingsUpdateBusy,
          })
        ),
        m(
          "fieldset.form-group",
          m("input.form-control.form-control-lg", {
            oninput: m.withAttr("value", setInputValue.bind(null, "username")),
        ...
        m(
          ...
          m("textarea.form-control.form-control-lg", {
            oninput: m.withAttr("value", setInputValue.bind(null, "bio")),
        ...
        m(
          "fieldset.form-group",
          m("input.form-control.form-control-lg", {
            oninput: m.withAttr("value", setInputValue.bind(null, "email")),
        ...
        m(
          "fieldset.form-group",
          m("input.form-control.form-control-lg", {
            oninput: m.withAttr("value", setInputValue.bind(null, "password")),
