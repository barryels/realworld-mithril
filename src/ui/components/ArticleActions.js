...
function view(vnode) {
  ...
  return [
    m(ArticleUpdateButton, {
      action: domain.actions.goToArticleEditScreen.bind(null, article.slug),
    }),
    m("span", " "),
    m(ArticleDeleteButton, {
      action: domain.actions.deleteArticle.bind(null, article.slug),
    }),
    m("span", " "),
...
export default { oninit, onupdate, view };
